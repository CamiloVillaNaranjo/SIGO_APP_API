...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceCatalog :  IEquatable<ServiceCatalog>
    {
        /// <summary>
        ...
        public ServiceCatalog(List<Addendums> AddendumsContracted = null, List<Complements> ComplementsContracted = null, List<PaperSheets> PaperSheetsOwned = null)
        {
        ...
        /// <summary>
        /// Gets or Sets AddendumsContracted
        /// </summary>
        [DataMember(Name="AddendumsContracted")]
        public List<Addendums> AddendumsContracted { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AddendumsContracted: ").Append(AddendumsContracted).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((ServiceCatalog)obj);
        }

        /// <summary>
        /// Returns true if ServiceCatalog instances are equal
        /// </summary>
        /// <param name="other">Instance of ServiceCatalog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceCatalog other)
        {
            ...
            return 
                (
                    this.AddendumsContracted == other.AddendumsContracted ||
                    this.AddendumsContracted != null &&
                    this.AddendumsContracted.SequenceEqual(other.AddendumsContracted)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AddendumsContracted != null)
                    hash = hash * 59 + this.AddendumsContracted.GetHashCode();
        ...
        public static bool operator ==(ServiceCatalog left, ServiceCatalog right)
        {
